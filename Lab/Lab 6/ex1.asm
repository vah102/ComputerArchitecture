#Laboratory 6, Home Assigment 1
#PhamVanAnh_20214988
.data
	A: .word -2, 6, -1, 3, -2, 10, 8, -2
	message1: .asciiz "Max sum prefic lenght is: "
	message2: .asciiz "\nPrefic is: "
.text 
main:
	la $a0, A		#a0: dia chi cua A
 	li $a1, 8		#a1: so phan tu cua mang
 	j mspfx		#mspfx: max sum prefix: tong lon nhat cua day con
 	nop
#-----------------------------------------------------------------
#Procedure mspfx
